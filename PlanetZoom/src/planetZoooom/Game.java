...
public class Game implements IGame 
{
	...
	private static final float[] HUD_BG_YELLOW = new float[] {1, 211.0f/255.0f, 42.0f/255.0f, 0.8f};
	private static final float[] HUD_BG_WHITE = new float[] {1, 1, 1, 0.5f};
	private static final float[] HUD_BG_PURPLE = new float[] {238.0f/255.0f, 170.0f/255.0f, 1f, 0.8f};
