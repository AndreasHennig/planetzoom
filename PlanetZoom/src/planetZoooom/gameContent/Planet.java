...
public class Planet implements IGameObjectListener
{
	...
	// {
	// float subdivisionCoefficient =
	// GameUtils.getDistanceCoefficient(planetCamDistance);
	//
	// int subdivisions = (int) (subdivisionCoefficient / 1.2 *
	// Sphere.MAX_SUBDIVISIONS);
	//
	// // clamp
	// subdivisions = subdivisions < Sphere.MIN_SUBDIVISIONS ?
	// Sphere.MIN_SUBDIVISIONS : subdivisions;
